...
public final class RecordAccumulator {
    ...
    public RecordAppendResult append(TopicPartition tp,
        ...
        try {
            ...
            //计算批次的大小,消息大小<batchSize,当前Batch 可能存在多条数据,否则1条数据
    ...
    public ReadyCheckResult ready(Cluster cluster, long nowMs) {
        ...
        // 有其他线程等待释放空间 -->true： 内存不够;会作为batch发送出去的条件之一
            ...
            synchronized (deque) {
                ...
                if (batch != null) {
                    ...
                    if (leader == null) {
                        ...
                        //deque.size() --> 队列中有多个批次
                        //batch.isFull() --> 该批次已经写满
                        // 是否有写满的批次
                        boolean full = deque.size() > 1 || batch.isFull();

                        //waitedTimeMs 已经等待多久;timeToWaitMs 最多等待多久;expired 是否达到最大等待时间
